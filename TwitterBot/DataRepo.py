    ...
    def GetTwitterData(self, account):
        ...
        try:
            ...
            if len(twitter_status) > 0:
                ...
                if last_time > self.dict_time[account]:
        ...
        while self.working:
            for account in Data.list_account:
                ...
                if len(list_msg) > 0:
                    ...
                    print("send a message through telegram, total number of message = ", len(list_msg))
                else:
                    print("empty list_ref")
            time.sleep(5)
